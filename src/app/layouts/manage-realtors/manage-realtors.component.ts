...
@Component({
  selector: 'app-manage-realtors',
  templateUrl: './manage-realtors.component.html',
  styleUrls: ['./manage-realtors.component.scss']
})
export class ManageRealtorsComponent implements OnInit {
